...
const { Event } = __webpack_require__(/*! jquery */ "../node_modules/jquery/dist/jquery.js");

const rateButtons = document.querySelectorAll('.button-rate label');
rateButtons.forEach(elem => elem.addEventListener('click', rateClickListener)
);
function rateClickListener(event) {
 console.log(event.target.for);
}
...
/******/ });
//# sourceMappingURL=main.e5c4b101e7840d6f1f91.js.map