  ...
  ! function () {
    var s, a, n, h = "2.2.3",
      ...
      l = {
        ...
        prevHtml: 'keyboard_arrow_left',
        nextHtml: 'keyboard_arrow_right',
        navTitles: {
          days: "MM, <i>yyyy</i>",
          months: "yyyy",
          years: "yyyy1 - yyyy2"
    ...
    function () {
      ...
      a.Navigation = function (t, e) {
        ...
        _addButtonsIfNeed: function () {
          this.opts.todayButton && this._addButton("clear"), this.opts.clearButton && this._addButton("today")
        },
        _render: function () {
        ...
        _getTitle: function (t) {
          console.log('t=' + t + 'this:' + this.d.formatDate(this.opts.navTitles[this.d.view], t));
...
//# sourceMappingURL=vendors~UIKit.48c9762db267bce52d5a.js.map