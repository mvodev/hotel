...
var StarRating = (_class = /*#__PURE__*/function () {
  ...
  _createClass(StarRating, [{
    ...
    value: function _handleRateButtonClick(event) {
      ...
      for (var i = 0; i < rateNumberUserChoice; i += 1) {
        this.starRatingLabels[i].innerHTML = 'star';
      }

      for (var j = rateNumberUserChoice; j < 5; j += 1) {
...
rateButtons.forEach(function (elem) {
  return new _star_rating_class_js__WEBPACK_IMPORTED_MODULE_0__["default"](elem);
});
    ...
    value: function _init() {
      $(this.sliderInput).ionRangeSlider({
        ...
        onChange: function onChange(data) {
          var minValue = '';
          var maxValue = '';
          if (data.from >= 1000) minValue = "".concat(Math.floor(data.from / 1000), "000");else minValue = data.from;
          if (data.to >= 1000) maxValue = "".concat(Math.floor(data.to / 1000), "000");else maxValue = data.to;
          $('.js-range-slider__label').html("".concat(minValue, "<span class=\"rub\">i</span> - ").concat(maxValue, "<span class=\"rub\">i</span>"));
        },
...
//# sourceMappingURL=UIKit~search.f02621309fa2e2372014.js.map