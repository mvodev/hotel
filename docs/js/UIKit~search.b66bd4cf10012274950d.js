    ...
    value: function _init() {
      $(this.sliderInput).ionRangeSlider({
        ...
        onChange: function onChange(data) {
          var minValue = '';
          var maxValue = '';
          if (data.from >= 1000) minValue = Math.floor(data.from / 1000) + ' 000';else minValue = data.from;
          if (data.to >= 1000) maxValue = Math.floor(data.to / 1000) + ' 000';else maxValue = data.to;
          $('.js-range-slider__label').html(minValue + '<span class="rub">i</span> - ' + maxValue + '<span class="rub">i</span>');
        },
...
document.querySelectorAll('.js-range-slider').forEach(function (elem) {
...
//# sourceMappingURL=UIKit~search.b66bd4cf10012274950d.js.map