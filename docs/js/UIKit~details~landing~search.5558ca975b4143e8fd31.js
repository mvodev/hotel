  ...
  _createClass(DropdownCount, [{
    ...
    value: function _collectData() {
      if (this.dropdownType === 'guests') {
        ...
        for (var i = 0; i < this.dropdownCounters.length; i++) {
    ...
    value: function _setData(result) {
      if (this.dropdownType === 'guests') {
        ...
        if (result.bedrooms > 0) {
          _temp += result.bedrooms + " " + this.spellCases.bedrooms[this._getPosInSpellCasesArray(result.bedrooms)];
        }

        if (result.beds > 0) {
          if (_temp.length > 0) {
            _temp += ",  " + result.beds + " " + this.spellCases.beds[this._getPosInSpellCasesArray(result.beds)];
          } else _temp += result.beds + " " + this.spellCases.beds[this._getPosInSpellCasesArray(result.beds)];
        }

        if (result.baths > 0) {
          if (_temp.length > 0) {
            _temp += ",  " + result.baths + " " + this.spellCases.baths[this._getPosInSpellCasesArray(result.baths)];
          } else _temp += result.baths + " " + this.spellCases.baths[this._getPosInSpellCasesArray(result.baths)];
        }
...
//# sourceMappingURL=UIKit~details~landing~search.5558ca975b4143e8fd31.js.map