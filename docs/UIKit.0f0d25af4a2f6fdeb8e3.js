...
function dropdownClickHandler(event) {
  console.log(event.target.parentNode.parentNode.childNodes[1]).classList.toggle('dropdown-room_active');
  //event.target.parentNode.childNodes[0].classList.toggle('dropdown-room_active');
...
/******/ });
//# sourceMappingURL=UIKit.0f0d25af4a2f6fdeb8e3.js.map