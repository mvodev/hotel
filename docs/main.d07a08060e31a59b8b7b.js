...
function likeClickListener(event) {
 if (event.target.className === '') {
  if (event.target.parentElement.classList.includes('button-like_is-liked')) {
  ...
  console.log('inside button-like__div condition');
  console.log(event.target);
 }
}
...
/******/ });
//# sourceMappingURL=main.d07a08060e31a59b8b7b.js.map