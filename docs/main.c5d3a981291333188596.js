...
const rateButton = document.querySelector('.button-rate label');
rateButton.addEventListener('click', rateClickListener);
function rateClickListener() {
...
/******/ });
//# sourceMappingURL=main.c5d3a981291333188596.js.map