...
function handler(event) {
  ...
  event.target.parentNode.parentNode.childNodes[1].classList.toggle('dropdown-guests_show');
  console.log(event.target.parentNode.parentNode.classList);
  //event.target.parentNode.parentNode.classList.toggle('dropdown-input__guests_rounding-corners-top');
  if (document
...
/******/ });
//# sourceMappingURL=UIKit.2c8ff478acdfe2276f2d.js.map