...
$('.range-slider').ionRangeSlider({
 ...
 onChange: function (data) {
  // let minValue = ''
  // let maxValue = ''
  // if (data.from >= 1000) minValue = Math.floor(data.from / 1000) + ' ' + (data.from - 1000);
  // else minValue = data.from;
  // if (data.to >= 1000) maxValue = Math.floor(data.to / 1000) + ' ' + (data.from - 1000);
...
/******/ });
//# sourceMappingURL=main.dd43e143da98a47c1395.js.map